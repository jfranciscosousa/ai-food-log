...
export function ErrorComponent({
  errorCode = 500,
  message = "We're experiencing some technical issues on our end. Please try again later or go back to the previous page.",
}: {
  errorCode?: number;
  message?: string;
}) {
...
export default function ErrorPage() {
  ...
  const message = isRouteError ? error.data.message : undefined;
  ...
  return <ErrorComponent errorCode={errorCode} message={message} />;
}
